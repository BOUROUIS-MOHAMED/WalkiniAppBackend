...
@Entity(name = "waitingProductManagingList")
public class WaitingProductManagingListModel {
    @Id
    @SequenceGenerator(
            allocationSize=1,
            name="waiting_product_managing_list_id_sequence",
            sequenceName = "waiting_product_managing_list_id_sequence")
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "waiting_product_managing_list_id_sequence"
    )
    ...
    @Column(name="modifiedProductId")
    private Integer modifiedProductId;
    @Column(name="name")
    private String name;
    ...
    public Integer getModifiedProductId() {
        return modifiedProductId;
    }

    public void setModifiedProductId(Integer modifiedProductId) {
        this.modifiedProductId = modifiedProductId;
    }
